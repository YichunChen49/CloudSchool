...
1. 選擇**「學期」**、**「班級」**、**「階段別」**。
2. 選擇要計算優異排名的**「科目」**。
3. 勾選是否**「加權計算」**、**「套用排除名單」**，選擇計算**「全年級」**或**「該班級」**。
4. 按下**「開始處理」**。
5. 統計結果顯示在標示處。
...
![](../.gitbook/assets/score-manage1.png)

1. 選擇**「學期」**、**「年級」**、**「階段別」**。
2. 若班級有部分學生成績未輸入，則會顯示未輸入人數，且圖示為紅色。**鎖頭圖示**表示成績已匯至教務處，任課老師無法修改，**按一下可解鎖**。
3. 若任課老師已完成全班學生成績輸入，圖示會顯示為綠色。**鎖頭圖示**表示成績已匯至教務處，任課老師無法修改，**按一下可解鎖**。
4. 若全班成績都沒有輸入，則顯示 ✘** 圖示**。
5. 勾選列印項目**「含組距表」**、**「 含排除名單 」**、**「列印學生簽名欄 **」。
6. 勾選班級可列印**班級階段成績檢核表**。
7. 按下**「計算機」**圖示，可結算班級成績。
...
3. 點選領域不及格人數可以顯示該領域不及格名單，如下圖。![](../.gitbook/assets/seme-score-fail-count2.png)
4. 可**「列印」**該次統計結果。
