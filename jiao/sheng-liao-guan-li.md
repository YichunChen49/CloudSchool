...
6. 若轉入生原就讀學校位在其他縣市，請使用**「教育部-學籍標準格式匯入」，**請選擇符合教育部學籍交換規格標準檔案格式匯入。
7. 匯入學生學籍後，可**「查看期中紀錄」**。
...
6. 若調出生新就讀學校位在其他縣市，請勾選並點擊**「匯出交換格式」**，選擇相符之學籍交換規格標準檔案，並傳送給對方學校註冊組。
...
3. 勾選**「顯示名次及加權」**選項，可在畢業成績列表中顯示名次及加權。
4. 標示處顯示所選班級的畢業成績。
...
2. 選擇成績採計方式:採計階段成績。
3. 選擇統計的科目及階段成績。
4. 按下「**成績試算預覽**」，下方將列出成績試算結果。
5. 可下載「**成績試算檔**」及「**匯出編班名冊**」。
...
1. 選擇「**學年度學期**」。&#x20;
2. 開立對象：「班級」可於功能按下「加入班級」，可在該筆在學證明紀錄中加入班級。「個別學生」可於功能按下「加入學生」，可在該筆在學證明紀錄中加入學生。
3. 如欲刪除已選班級或學生，請點擊「**垃圾桶**」圖示即可。&#x20;
4. 點擊「**編輯**」按鈕可修改停課證明相關內容 。
5. 點選「**列印**」按鈕，可在新視窗中列印所加入學生的停課證明書。&#x20;
6. 點選 「**刪除**」 按鈕，可以刪除該筆資料。
