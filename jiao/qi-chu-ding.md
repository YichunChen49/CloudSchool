...
1. 輸入**「班序」**，此為班級排序，請輸入數字。
2. 輸入**「班名」**，如ㄧ、二、三...甲、乙、丙。
3. 班級性質：普通班（需選年級：含分齡特教班）、特殊班（混齡）。
4. （特殊班）特教類別：身心障礙類、資賦優異類。
5. （特殊班）特教性質：
   * 身心障礙類：智能障礙、視覺障礙、聽覺障礙、語言障礙、肢體障礙、腦性麻痺、身體病弱、情緒行為障礙、學習障礙、多重障礙、自閉症、發展遲緩、其他障礙。
   * 資賦優異類：一般智能資賦優異、學術性向資賦優異、藝術才能資賦優異、創造能力資賦優異、領導能力資賦優異、其他特殊才能資賦優異。
6. （特殊班）特教班上課性質：集中式、分散式巡迴輔導。
7. 按下「確定」，儲存班級設定。
