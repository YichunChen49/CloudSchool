...
1. 選擇**「假別」**。公差、公出、公假：於假日可勾選假日加班選項。
2. 選擇**「學期」**，不得選擇過去學期，若沒有未來學期可以選，則需請註冊組先建立新學期。
3. 填寫**「事由」**，公差假可填寫**「公差地點」**；出國可檢附已申請之出國申請表。
...
![](<../.gitbook/assets/absent-show-all (1).png>)

1. 選擇**「學期、請假教師、假別、假單狀態」**篩選假單紀錄。
2. 假單登錄人員，在假單簽核完畢後可以按下**「登錄」**。
3. 擁有「差假列表」權限人員，都可以**「編輯」**假單；擁有「假單登錄」權限人員，可以**「編輯、註銷」**假單。（如代理人尚未簽核，僅能由請假人提出銷假申請）
...
2. 此處僅會計算已登錄差假紀錄。
3. 可匯出**「人事行政總處格式之 CSV 檔(差假)」、「人事行政總處格式之 JSON檔(差價與加班)」、「未休假加班費清冊(兼行政教師)」、「未休假加班費清冊(職員)」**
4. 可**「列印」**統計結果。
...
3.  具假單登錄權限人員，在申請單簽核完畢後可以按下**「登錄」**，亦可以**「編輯、刪除」**申請單，如下圖
...
![](../.gitbook/assets/absent-overtime-show-all.png)

1. 選擇**「加班類型」**、**「教職員」**、**「加班起訖時間」**篩選加班列表。
2. 標示處列出篩選後的加班列表。
3. 點擊**「匯出」**，可匯出加班本文檔之CSV檔。
...
3. 點擊**「整批匯入」**，可批次匯入多筆補休案件，請參照說明步驟操作。&#x20;
