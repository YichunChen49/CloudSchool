...
{% hint style="info" %}
此分類授權僅為新增訊息時可選擇訊息分類之權限，如需開啟新增訊息權限，請至模組管理進行授權設定。授權方式可參考[模組管理](../xi-guan-li-mo/module.md#mo-zu-guan-li)。
{% endhint %}
{% endtab %}
{% endtabs %}
...
5. 點擊「下載EXCEL報表」，可下載填報結果檔案以查看表單所有填報內容。
{% endtab %}
{% endtabs %}
...
![](../.gitbook/assets/calendar-set1.png)
...
3.  按下**「權限」**，設定單位回覆通報的人員，有權限者才能回復維修狀況，如下圖。
